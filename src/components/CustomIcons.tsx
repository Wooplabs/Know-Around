...
export const GroupIcon: React.FC<IconProps> = ({ color, size = 24, style }) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
      <Path
        d="M15.5 11C15.5 10.5404 15.4095 10.0852 15.2336 9.66061C15.0577 9.23597 14.7999 8.85013 14.4749 8.52513C14.1499 8.20012 13.764 7.94231 13.3394 7.76642C12.9148 7.59053 12.4596 7.5 12 7.5C11.5404 7.5 11.0852 7.59053 10.6606 7.76642C10.236 7.94231 9.85013 8.20012 9.52513 8.52513C9.20012 8.85013 8.94231 9.23597 8.76642 9.66061C8.59053 10.0852 8.5 10.5404 8.5 11C8.5 11.9283 8.86875 12.8185 9.52513 13.4749C10.1815 14.1313 11.0717 14.5 12 14.5C12.9283 14.5 13.8185 14.1313 14.4749 13.4749C15.1313 12.8185 15.5 11.9283 15.5 11Z"
        stroke={strokeColor}
        strokeWidth="2.6"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <Path
        d="M22 16.5C22 13.739 19.538 11.5 16.5 11.5C16.1447 11.4993 15.8057 11.4493 15.483 11.35M16.5 11.5C17.1773 11.4999 17.84 11.3033 18.4078 10.934C18.9755 10.5647 19.4239 10.0386 19.6986 9.41957C19.9733 8.80049 20.0625 8.115 19.9554 7.44624C19.8482 6.77748 19.5493 6.15418 19.0949 5.65193C18.6406 5.14967 18.0502 4.79004 17.3955 4.61664C16.7408 4.44325 16.0498 4.46354 15.4064 4.67506C14.763 4.88657 14.1948 5.28023 13.7706 5.80828C13.3465 6.33634 13.0847 6.97611 13.017 7.65M10.983 7.65C10.9107 6.93242 10.6185 6.2547 10.1464 5.70952C9.67421 5.16434 9.04518 4.77832 8.34528 4.60427C7.64539 4.43022 6.90882 4.47663 6.23631 4.73716C5.5638 4.99769 4.98819 5.4596 4.58821 6.05974C4.18823 6.65987 3.98341 7.36891 4.00176 8.08989C4.02011 8.81086 4.26074 9.50857 4.69074 10.0876C5.12073 10.6666 5.7191 11.0986 6.40399 11.3246C7.08889 11.5506 7.82687 11.5594 8.517 11.35M17.5 19.5C17.5 16.739 15.038 14.5 12 14.5C8.962 14.5 6.5 16.739 6.5 19.5"
        stroke={strokeColor}
        strokeWidth="2.6"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <Path
        d="M7.5 11.5C4.462 11.5 2 13.739 2 16.5"
        stroke={strokeColor}
        strokeWidth="2.6"
        strokeLinecap="round"
        strokeLinejoin="round"
