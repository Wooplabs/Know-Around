  ...
  return (
    <View style={[styles.card, darkMode && styles.cardDark]}>
      ...
      <View style={styles.header}>
        <UserAvatar name={post.author} avatarUrl={post.avatar} size={42} style={{ marginRight: 10 }} />
            ...
            {(expandedComments ? post.comments : post.comments.slice(0, 2)).map((comment) => (
              <View key={comment.id} style={styles.threadContainer}>
                ...
                <View style={styles.commentRow}>
                  <UserAvatar name={comment.author} avatarUrl={comment.avatar} size={32} style={{ marginRight: 10 }} />
                ...
                {comment.replies && comment.replies.map((reply) => (
                  <View key={reply.id} style={styles.replyRow}>
                    <UserAvatar name={reply.author} avatarUrl={reply.avatar} size={28} style={{ marginRight: 10 }} />
